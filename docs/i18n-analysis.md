...
- pages/* (login, register, verify-email, invite, admin, settings, crm/*, tasks, projects, habits, journal, notes, calendar, billing, create-workspace, workspace-settings, workspace-modules, module-activation, module-stub)
