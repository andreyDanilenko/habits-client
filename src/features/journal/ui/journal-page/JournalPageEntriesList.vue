<template>
  <div class="space-y-8">
    <div v-for="group in groupedEntries" :key="group.date" class="space-y-4">
      <div class="flex items-center gap-3 sticky top-0 bg-bg-primary/80 backdrop-blur-sm py-2 z-10 -mx-2 px-2 rounded-lg">
        ...
        <Badge variant="outline" size="sm" class="bg-badge-default-bg text-badge-default-text border-border-default">
