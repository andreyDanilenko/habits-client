...
export { default as DetailTabsPanel } from './DetailTabsPanel.vue'
export { default as DetailListSection } from './DetailListSection.vue'
export { default as DealsListSection } from './DealsListSection.vue'
